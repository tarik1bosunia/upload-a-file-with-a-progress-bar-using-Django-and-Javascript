...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\program learn\Python\Django\upload_file_with_progressbar\venv'
    let bin = 'bin'
    let path_sep = ';'
...
alias deactivate = source 'E:\program learn\Python\Django\upload_file_with_progressbar\venv\bin\deactivate.nu'
